...
from datetime import datetime  # To fetch system date
...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'S40037 - T02 - 20241015 - 104655', 0, 1, 'R')  # Adjust as necessary
...
# Function to generate the PDF with user input data
def generate_pdf(data):
    ...
    workflow_history = [
        [data['Creator'], current_date, "Location", ""]
    ]
